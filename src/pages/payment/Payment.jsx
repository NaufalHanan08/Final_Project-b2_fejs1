          ...
          <div className="relative px-4 sm:px-6 lg:px-8 pb-8 max-w-lg mx-auto">
            <div className="bg-white px-8 pb-6 rounded-b shadow-lg">
              ...
              <div className="text-center mb-6">
                <h1 className="text-xl leading-snug text-gray-800 font-semibold mb-2">Pembayaran Kelas</h1>
                <div className="text-sm">Lakukan pembayaran untuk materi pembelajaran yang lebih jauh lagi.</div>
              </div>
              ...
              <div className="flex justify-center mb-6">
                <div className="relative flex w-full p-1 bg-gray-50 rounded">
                  ...
                  <button className="relative flex-1 text-sm font-medium p-1 transition duration-150 ease-in-out focus:outline-none focus-visible:ring-2" onClick={() => setCard(true)}>
                    Bayar dengan Kartu
                  </button>
                  <button className="relative flex-1 text-sm font-medium p-1 transition duration-150 ease-in-out focus:outline-none focus-visible:ring-2" onClick={() => setCard(false)}>
                    Bayar dengan PayPal
                  </button>
                </div>
              </div>
              ...
              {card && (
                <div className="space-y-4">
                  ...
                  <div className="mt-6">
                    ...
                    <div className="text-xs text-gray-500 italic text-center">Anda akan dikenakan biaya Rp. 100.000, termasuk Rp. 10.000 untuk PPN di Indonesia</div>
                  </div>
                </div>
              )}
