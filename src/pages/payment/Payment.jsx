          ...
          <div className="relative px-4 sm:px-6 lg:px-8 pb-8 max-w-lg mx-auto">
            <div className="bg-white px-8 pb-6 rounded-b shadow-lg">
              ...
              <div className="text-center mb-6">
                ...
                <div className="text-sm">Pelajari cara membuat aplikasi web nyata menggunakan HTML & CSS. Templat kode sudah disertakan.</div>
              </div>
              ...
              {card && (
                <div className="space-y-4">
                  ...
                  <div className="mt-6">
                    ...
                    <div className="text-xs text-gray-500 italic text-center">Anda akan dikenakan biaya $253, termasuk $48 untuk PPN di Italia</div>
                  </div>
                </div>
              )}
