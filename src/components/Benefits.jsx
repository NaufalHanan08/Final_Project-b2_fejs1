    ...
    return (
      <div className="benefits-img w-full flex justify-end">
        <div className="benefits-content md:w-2/4 w-full py-28 px-10 overflow-hidden">
          <h3 className="bg-gray-700 text-white font-bold ps-5 shadow-md">
            LEARN ANYTHING
          </h3>
          ...
          <div className="flex flex-col gap-3">
            <a href="" className="bg-slate-100 hover:bg-gray-700 p-10 text-black hover:text-white transition-all duration-300">
              <h2 className="text-2xl mb-3">Online Courses</h2>
              <p>
            ...
            <a href="" className="bg-slate-100 hover:bg-gray-700 p-10 text-black hover:text-white transition-all duration-300">
              <h2 className="text-2xl mb-3">Earn A Certificates</h2>
              <p>
            ...
            <a href="" className="bg-slate-100 hover:bg-gray-700 p-10 text-black hover:text-white transition-all duration-300">
              <h2 className="text-2xl mb-3">Learn with Expert</h2>
              <p>
