      ...
      <div className="bg-hero w-full md:h-fit md:block flex flex-col-reverse items-center md:px-6 px-5">
        ...
        <div className="md:pb-0 pb-6">
          <img
            src={heroimg}
            alt="hero-img"
            className="md:h-80 h-3/4 md:absolute static md:mt-0 mt-20 right-20 lg:top-48 md:top-60 bg-teal-600 border-b-4 border-teal-900 rounded-full p-3 shadow-lg shadow-teal-900"
          />
        </div>
      </div>
    </div>
