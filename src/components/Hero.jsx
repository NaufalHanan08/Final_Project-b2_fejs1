  ...
  return (
    <div className="w-full bg-teal-600">
      <div className="bg-hero w-full md:h-fit md:block flex flex-col-reverse items-center md:px-20 px-5">
        ...
        <div>
          <img src={heroimg} alt="hero-img" className="md:h-80 h-3/4 md:absolute static md:mt-0 mt-20 right-20 bottom-32  bg-teal-600 border-b-4 border-teal-900 rounded-full p-3 shadow-xl shadow-teal-900" />
        </div>
      </div>
    </div>
  );
