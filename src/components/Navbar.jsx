  ...
  return (
    <div>
          ...
          {(ref) => (
            <div className="md:hidden" id="mobile-menu">
              <div ref={ref} className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                ...
                <Link to="/Login">
                  <button className="w-24 mr-3 bg-teal-900 border border-teal-900 hover:bg-transparent transition-all rounded-md text-white font-semibold text-sm py-2">Login</button>
                </Link>
                <Link to="/Register">
                  <button className="w-24 bg-teal-900 border border-teal-900 hover:bg-transparent transition-all rounded-md text-white font-semibold text-sm py-2">Register</button>
                </Link>
              </div>
            </div>
          )}
      ...
      <div className="md:flex hidden gap-2 fixed top-3 md:end-5 end-20 z-50">
        <Link to="/Login">
          <button className="w-24 bg-teal-900 border border-teal-900 hover:bg-transparent transition-all rounded-md text-white font-semibold text-sm py-2">Login</button>
        </Link>
        <Link to="/Register">
          <button className="w-24 bg-teal-900 border border-teal-900 hover:bg-transparent transition-all rounded-md text-white font-semibold text-sm py-2">Register</button>
        </Link>
