  ...
  return (
    <div className="py-28 flex flex-col items-center xl:px-20 md:px-14 sm:px-8 px-4">
      ...
      <div className="w-full px-5">
        <a onClick={() => navigate("/course")} className="flex sm:justify-end justify-center underline text-gray-800 font-semibold text-lg cursor-pointer">Lihat semua course</a>
      </div>
    </div>
  );
}
